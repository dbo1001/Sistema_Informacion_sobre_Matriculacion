...
\tablaSmallSinColores{Caso de uso 4: Gráfico apilado de Asignaturas por Curso }{p{3cm} p{.75cm} p{9.5cm}}{b1}{
\multicolumn{3}{l}{Caso de uso 4: Gráfico apilado de Asignaturas por Curso} \\
}
{
...
\tablaSmallSinColores{Caso de uso 5: Gráfico de máximos, mínimos y medias por curso }{p{3cm} p{.75cm} p{9.5cm}}{b1}{
\multicolumn{3}{l}{Caso de uso 5: Gráfico de máximos, mínimos y medias por curso} \\
}
{
...
\tablaSmallSinColores{Caso de uso 6: Salir de la aplicación}{p{3cm} p{.75cm} p{9.5cm}}{b1}{
\multicolumn{3}{l}{Caso de uso 6: Salir de la aplicación} \\
}
{
